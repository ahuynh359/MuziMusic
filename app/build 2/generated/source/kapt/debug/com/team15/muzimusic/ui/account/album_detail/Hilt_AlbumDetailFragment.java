 ...
 */
public abstract class Hilt_AlbumDetailFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlbumDetailFragment_GeneratedInjector) this.generatedComponent()).injectAlbumDetailFragment(UnsafeCasts.<AlbumDetailFragment>unsafeCast(this));
    }
  }
