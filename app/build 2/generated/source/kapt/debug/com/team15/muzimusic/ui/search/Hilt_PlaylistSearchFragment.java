 ...
 */
public abstract class Hilt_PlaylistSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PlaylistSearchFragment() {
    super();
  }

  Hilt_PlaylistSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlaylistSearchFragment_GeneratedInjector) this.generatedComponent()).injectPlaylistSearchFragment(UnsafeCasts.<PlaylistSearchFragment>unsafeCast(this));
    }
  }
