 ...
 */
public abstract class Hilt_FormAlbumDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FormAlbumDialogFragment() {
    super();
  }

  Hilt_FormAlbumDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FormAlbumDialogFragment_GeneratedInjector) this.generatedComponent()).injectFormAlbumDialogFragment(UnsafeCasts.<FormAlbumDialogFragment>unsafeCast(this));
    }
  }
