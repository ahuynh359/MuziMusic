 ...
 */
public abstract class Hilt_FollowersFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FollowersFragment_GeneratedInjector) this.generatedComponent()).injectFollowersFragment(UnsafeCasts.<FollowersFragment>unsafeCast(this));
    }
  }
