 ...
 */
public abstract class Hilt_MySongsFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MySongsFragment_GeneratedInjector) this.generatedComponent()).injectMySongsFragment(UnsafeCasts.<MySongsFragment>unsafeCast(this));
    }
  }
