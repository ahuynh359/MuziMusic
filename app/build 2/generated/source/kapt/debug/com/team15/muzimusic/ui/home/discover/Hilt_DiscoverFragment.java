 ...
 */
public abstract class Hilt_DiscoverFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DiscoverFragment() {
    super();
  }

  Hilt_DiscoverFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiscoverFragment_GeneratedInjector) this.generatedComponent()).injectDiscoverFragment(UnsafeCasts.<DiscoverFragment>unsafeCast(this));
    }
  }
