 ...
 */
public abstract class Hilt_SongToPlaylistFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SongToPlaylistFragment_GeneratedInjector) this.generatedComponent()).injectSongToPlaylistFragment(UnsafeCasts.<SongToPlaylistFragment>unsafeCast(this));
    }
  }
