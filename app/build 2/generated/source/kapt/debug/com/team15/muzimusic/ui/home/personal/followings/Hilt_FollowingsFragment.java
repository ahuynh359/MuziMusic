 ...
 */
public abstract class Hilt_FollowingsFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FollowingsFragment_GeneratedInjector) this.generatedComponent()).injectFollowingsFragment(UnsafeCasts.<FollowingsFragment>unsafeCast(this));
    }
  }
