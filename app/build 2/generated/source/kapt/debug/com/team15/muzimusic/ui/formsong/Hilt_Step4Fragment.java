 ...
 */
public abstract class Hilt_Step4Fragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Step4Fragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Step4Fragment_GeneratedInjector) this.generatedComponent()).injectStep4Fragment(UnsafeCasts.<Step4Fragment>unsafeCast(this));
    }
  }
