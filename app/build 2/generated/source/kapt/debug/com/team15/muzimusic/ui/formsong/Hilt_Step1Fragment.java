 ...
 */
public abstract class Hilt_Step1Fragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Step1Fragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Step1Fragment_GeneratedInjector) this.generatedComponent()).injectStep1Fragment(UnsafeCasts.<Step1Fragment>unsafeCast(this));
    }
  }
