 ...
 */
public abstract class Hilt_AlbumFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlbumFragment_GeneratedInjector) this.generatedComponent()).injectAlbumFragment(UnsafeCasts.<AlbumFragment>unsafeCast(this));
    }
  }
