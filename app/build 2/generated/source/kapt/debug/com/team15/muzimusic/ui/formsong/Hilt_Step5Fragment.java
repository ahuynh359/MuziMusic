 ...
 */
public abstract class Hilt_Step5Fragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Step5Fragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Step5Fragment_GeneratedInjector) this.generatedComponent()).injectStep5Fragment(UnsafeCasts.<Step5Fragment>unsafeCast(this));
    }
  }
