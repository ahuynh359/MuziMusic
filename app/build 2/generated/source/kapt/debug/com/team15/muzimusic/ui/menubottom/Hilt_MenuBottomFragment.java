 ...
 */
public abstract class Hilt_MenuBottomFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MenuBottomFragment_GeneratedInjector) this.generatedComponent()).injectMenuBottomFragment(UnsafeCasts.<MenuBottomFragment>unsafeCast(this));
    }
  }
