 ...
 */
public abstract class Hilt_SongLyricsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SongLyricsFragment() {
    super();
  }

  Hilt_SongLyricsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SongLyricsFragment_GeneratedInjector) this.generatedComponent()).injectSongLyricsFragment(UnsafeCasts.<SongLyricsFragment>unsafeCast(this));
    }
  }
