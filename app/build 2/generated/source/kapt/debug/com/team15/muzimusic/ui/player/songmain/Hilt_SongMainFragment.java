 ...
 */
public abstract class Hilt_SongMainFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SongMainFragment() {
    super();
  }

  Hilt_SongMainFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SongMainFragment_GeneratedInjector) this.generatedComponent()).injectSongMainFragment(UnsafeCasts.<SongMainFragment>unsafeCast(this));
    }
  }
