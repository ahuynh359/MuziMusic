 ...
 */
public abstract class Hilt_FormPlaylistFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FormPlaylistFragment() {
    super();
  }

  Hilt_FormPlaylistFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FormPlaylistFragment_GeneratedInjector) this.generatedComponent()).injectFormPlaylistFragment(UnsafeCasts.<FormPlaylistFragment>unsafeCast(this));
    }
  }
