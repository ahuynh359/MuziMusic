 ...
 */
public abstract class Hilt_Step2Fragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Step2Fragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Step2Fragment_GeneratedInjector) this.generatedComponent()).injectStep2Fragment(UnsafeCasts.<Step2Fragment>unsafeCast(this));
    }
  }
