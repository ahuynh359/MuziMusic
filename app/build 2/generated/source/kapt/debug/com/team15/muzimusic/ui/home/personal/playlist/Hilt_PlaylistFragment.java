 ...
 */
public abstract class Hilt_PlaylistFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlaylistFragment_GeneratedInjector) this.generatedComponent()).injectPlaylistFragment(UnsafeCasts.<PlaylistFragment>unsafeCast(this));
    }
  }
