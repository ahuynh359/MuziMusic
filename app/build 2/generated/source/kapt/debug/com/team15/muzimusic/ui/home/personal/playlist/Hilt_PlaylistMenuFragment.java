 ...
 */
public abstract class Hilt_PlaylistMenuFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlaylistMenuFragment_GeneratedInjector) this.generatedComponent()).injectPlaylistMenuFragment(UnsafeCasts.<PlaylistMenuFragment>unsafeCast(this));
    }
  }
