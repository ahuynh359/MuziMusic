 ...
 */
public abstract class Hilt_SongSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SongSearchFragment() {
    super();
  }

  Hilt_SongSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SongSearchFragment_GeneratedInjector) this.generatedComponent()).injectSongSearchFragment(UnsafeCasts.<SongSearchFragment>unsafeCast(this));
    }
  }
