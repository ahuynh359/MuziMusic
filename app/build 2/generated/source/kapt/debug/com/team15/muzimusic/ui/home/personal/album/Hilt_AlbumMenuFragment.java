 ...
 */
public abstract class Hilt_AlbumMenuFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlbumMenuFragment_GeneratedInjector) this.generatedComponent()).injectAlbumMenuFragment(UnsafeCasts.<AlbumMenuFragment>unsafeCast(this));
    }
  }
