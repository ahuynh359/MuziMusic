 ...
 */
public abstract class Hilt_PlaylistDetailFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlaylistDetailFragment_GeneratedInjector) this.generatedComponent()).injectPlaylistDetailFragment(UnsafeCasts.<PlaylistDetailFragment>unsafeCast(this));
    }
  }
