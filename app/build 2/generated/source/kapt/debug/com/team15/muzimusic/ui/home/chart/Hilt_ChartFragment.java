 ...
 */
public abstract class Hilt_ChartFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChartFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChartFragment_GeneratedInjector) this.generatedComponent()).injectChartFragment(UnsafeCasts.<ChartFragment>unsafeCast(this));
    }
  }
