 ...
 */
public abstract class Hilt_ChangeProfileFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChangeProfileFragment() {
    super();
  }

  Hilt_ChangeProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChangeProfileFragment_GeneratedInjector) this.generatedComponent()).injectChangeProfileFragment(UnsafeCasts.<ChangeProfileFragment>unsafeCast(this));
    }
  }
