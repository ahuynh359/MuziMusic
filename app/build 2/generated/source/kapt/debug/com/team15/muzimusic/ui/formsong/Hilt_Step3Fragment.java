 ...
 */
public abstract class Hilt_Step3Fragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Step3Fragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Step3Fragment_GeneratedInjector) this.generatedComponent()).injectStep3Fragment(UnsafeCasts.<Step3Fragment>unsafeCast(this));
    }
  }
