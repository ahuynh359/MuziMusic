 ...
 */
public abstract class Hilt_NotificationMenuFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotificationMenuFragment_GeneratedInjector) this.generatedComponent()).injectNotificationMenuFragment(UnsafeCasts.<NotificationMenuFragment>unsafeCast(this));
    }
  }
