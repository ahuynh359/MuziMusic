 ...
 */
public abstract class Hilt_AccountSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AccountSearchFragment() {
    super();
  }

  Hilt_AccountSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AccountSearchFragment_GeneratedInjector) this.generatedComponent()).injectAccountSearchFragment(UnsafeCasts.<AccountSearchFragment>unsafeCast(this));
    }
  }
