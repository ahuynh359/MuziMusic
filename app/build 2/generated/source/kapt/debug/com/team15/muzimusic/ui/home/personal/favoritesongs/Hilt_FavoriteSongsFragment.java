 ...
 */
public abstract class Hilt_FavoriteSongsFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoriteSongsFragment_GeneratedInjector) this.generatedComponent()).injectFavoriteSongsFragment(UnsafeCasts.<FavoriteSongsFragment>unsafeCast(this));
    }
  }
