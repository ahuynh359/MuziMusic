...
public final class FragmentPlaylistSearchBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPlaylistSearchBinding(@NonNull RelativeLayout rootView,
  ...
  public static FragmentPlaylistSearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPlaylistSearchBinding((RelativeLayout) rootView, recyclerView, tvNoResult);
    }
