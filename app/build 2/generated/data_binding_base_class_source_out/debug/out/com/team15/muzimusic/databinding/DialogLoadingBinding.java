...
public final class DialogLoadingBinding implements ViewBinding {
  ...
  private DialogLoadingBinding(@NonNull LinearLayout rootView,
      @NonNull CircularProgressIndicator pbLoading, @NonNull TextView tvLoadingTitle) {
  ...
  public static DialogLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvLoadingTitle;
      TextView tvLoadingTitle = ViewBindings.findChildViewById(rootView, id);
      if (tvLoadingTitle == null) {
        break missingId;
      }

      return new DialogLoadingBinding((LinearLayout) rootView, pbLoading, tvLoadingTitle);
    }
