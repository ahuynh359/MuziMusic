...
public final class ActivityGetStartedBinding implements ViewBinding {
  ...
  private ActivityGetStartedBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatButton btnGetStarted, @NonNull AppCompatImageView imvLogo,
      @NonNull AppCompatTextView tvDetail) {
  ...
  public static ActivityGetStartedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_detail;
      AppCompatTextView tvDetail = ViewBindings.findChildViewById(rootView, id);
      if (tvDetail == null) {
        break missingId;
      }

      return new ActivityGetStartedBinding((ConstraintLayout) rootView, btnGetStarted, imvLogo,
          tvDetail);
    }
