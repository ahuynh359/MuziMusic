...
public final class FragmentPlaylistDetailBinding implements ViewBinding {
  ...
  private FragmentPlaylistDetailBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recyclerSong, @NonNull TextView tvAccountName,
      @NonNull TextView tvPlaylistName, @NonNull TextView tvTotalSongs) {
  ...
  public static FragmentPlaylistDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPlaylistDetailBinding((LinearLayout) rootView, recyclerSong, tvAccountName,
          tvPlaylistName, tvTotalSongs);
    }
